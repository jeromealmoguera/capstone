                        ...
                        <ul class="row g-gs preview-icon-svg">
                            <li class="col-lg-3 col-sm-6 col-12">
                                <div class="preview-icon-box card card-bordered">
                                    ...
                                    <div> <span class="title fw-bold fs-17px">Users</span> <span class="fw-medium">{{ $totalUsers }}</span></div>
                            ...
                            <li class="col-lg-3 col-sm-6 col-12">
                                <div class="preview-icon-box card card-bordered">
                                    ...
                                    <div> <span class="title fw-bold fs-17px">Personnel</span> <span class="fw-medium">{{ $totalPersonnel }}</span></div>
                                    <a class="fw-medium" href="{{ route('personnel-listing') }}">View Personnel</a>
                                </div><!-- .preview-icon-box -->
                            </li><!-- .col -->
                            <li class="col-lg-3 col-sm-6 col-12">
                                <div class="preview-icon-box card card-bordered">
                                    ...
                                    <div> <span class="title fw-bold fs-17px">Documents</span> <span class="fw-medium">{{ $totalDocuments }}</span></div>
                                    <a class="fw-medium" href="{{ route('view.documents-lists') }}">View Documents</a>
                                </div><!-- .preview-icon-box -->
                            </li><!-- .col -->
                            <li class="col-lg-3 col-sm-6 col-12">
                                <div class="preview-icon-box card card-bordered">
